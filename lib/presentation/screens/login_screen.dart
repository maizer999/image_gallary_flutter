                                ...
                                child: BlocConsumer<LoginBloc, LoginState>(
                                  ...
                                  builder: (context, state) {
                                    return ElevatedButton(
                                        onPressed: () {
                                          // Directly navigate to gallery screen without login validation
                                          CacheHelper.saveData('token', 'dummy_token').then((value) {
                                            Navigator.pushNamedAndRemoveUntil(
                                                context, Routers.galleryScreen, (route) => false);
                                          });
                                        },
